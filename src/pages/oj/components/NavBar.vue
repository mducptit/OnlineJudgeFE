    ...
    <Menu theme="light" mode="horizontal" @on-select="handleRoute" :active-name="activeMenu" :class="oj-menu">
      ...
      <Dropdown @on-click="switchChange" class="ivu-menu-submenu">
        ...
        <DropdownMenu slot="list">
          <DropdownItem name="1"><Icon type="ios-browsers" color="#2d8cf0" />&emsp;{{$t('m.Skin_Blue')}}</DropdownItem>
          <DropdownItem name="2"><Icon type="ios-browsers" color="#f58f98" />&emsp;{{$t('m.Skin_Pink')}}</DropdownItem>
	        <DropdownItem name="4"><Icon type="ios-browsers" color="#d63031" />&emsp;{{$t('m.Skin_Red')}}</DropdownItem>
		      <DropdownItem name="5"><Icon type="ios-browsers" color="#00b894" />&emsp;{{$t('m.Skin_Cyan')}}</DropdownItem>
          <DropdownItem name="3"><Icon type="ios-browsers" color="#673AB7" />&emsp;{{$t('m.Skin_Purple')}}</DropdownItem>
        </DropdownMenu>
      </Dropdown>
