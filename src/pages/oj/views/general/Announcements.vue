  ...
  <Row type="flex" :gutter="18">
      ...
      <Row v-if="!isContest" type="flex" :gutter="10" style="margin-top: 70px;">
            <Col  :span="12">
              <Panel shadow style="padding-top: 0px;padding-bottom: 10px;">
                <div slot="title" style="margin-left: -10px;margin-bottom: -10px;">{{$t('m.NewProblems')}}</div>
    ...
    <Col :span="5" v-if="!isContest" >
      ...
      <Panel shadow style="margin-top: 37px;padding-bottom: 5px;">
        ...
        <ul style="margin-left: 40px;margin-bottom: 20px;">
          <li style="padding: 5px 0px;"><a href="#" class="link-style" onclick="event.preventDefault();window.open('https://codeforces.com/?ref=itmc', '_blank');">Codeforces</a></li>
          <li style="padding: 5px 0px;"><a href="#" class="link-style" onclick="event.preventDefault();window.open('https://leetcode.com/?ref=itmc', '_blank');">LeetCode</a></li>
          <li style="padding: 5px 0px;"><a href="#" class="link-style" onclick="event.preventDefault();window.open('https://www.facebook.com/it.multimedia.club', '_blank');">Information Technology Multimedia Club</a></li>
        </ul>
      </Panel>
    </Col>
  </Row>
